...
class GitLabClient {
  ...
  project(fullPath: $fullPath) {
    pipeline(iid: $iid) {
      ...
      ref sha source path
      detailedStatus { text label icon detailsPath }
    ...
    try {
      ...
      return (project && project.pipeline) || null;
    } catch (err) {
      return null;
    }
  }
...
module.exports = { GitLabClient, GitLabError, ACCESS, isTerminal, messageFromBody };
